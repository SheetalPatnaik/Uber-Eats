...
//     // Optionally add the image if it's selected
//     if (image) {
...
//       try {
//         const response = await axios.post("http://localhost:8000/accounts/api/add-menu-item/", formData, {
//           headers: {
//             'Content-Type': 'multipart/form-data',
//             'Authorization': `Basic ${btoa('rest8:rest8')}`, // Using basic auth with username and password
//           },
//         });
...
//       try {
//         const response = await axios.post("http://localhost:8000/accounts/api/add-menu-item/", data, {
//           headers: {
...
//           {/* // Add status dropdown in the form */}
//         <Grid item xs={12}>
...
const MenuItemForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = { category, name, description, price, status };
    const formData = new FormData();
